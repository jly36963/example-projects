...
const routes = async (app, options) => {
    ...
    app.post("/single", { preHandler: [auth_1.default, upload.single("file")] }, async (request, reply) => {
        try {
    ...
    app.post("/array", { preHandler: [auth_1.default, upload.array("files")] }, async (request, reply) => {
        try {
            const { files } = request;
            const filenames = [];
