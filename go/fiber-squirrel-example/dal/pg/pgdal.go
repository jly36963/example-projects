...
type IPostgresDAL interface {
	...
	// ninjas_jutsus
	AssociateNinjaJutsu(ninjaID, jutsuID string) error
	DissociateNinjaJutsu(ninjaID string, jutsuID string) error
...
func (dal *PostgresDAL) AssociateNinjaJutsu(ninjaID, jutsuID string) error {
	// get query builder
	qb := dal.getQB()
	insertBuilder := qb.
...
func (dal *PostgresDAL) DissociateNinjaJutsu(ninjaID string, jutsuID string) error {
	// get query builder
	qb := dal.getQB()
	deleteBuilder := qb.
