<script>
  ...
  // redefine d3.least (since it was removed in version 5.x)  
  ...
  $: if (data && Object.keys(data).length && d3Container) {
...
<svelte:head>
  <title>Svelte Multi-line Chart</title>
</svelte:head>
